...
#Region "INIRead Overloads"
    ...
    ''' <summary>
    ''' Returns the value of the specified key with a zero-length default (string.Empty)
    ''' </summary>
    ''' <param name="INIPath">The INI path.</param>
    ''' <param name="SectionName">Name of the section.</param>
    ''' <param name="KeyName">Name of the key.</param><returns></returns>
    ...
    ''' <summary>
    ''' Returns the name of all keys in the specified section.
    ''' </summary>
    ''' <param name="INIPath">The INI path.</param>
    ...
    ''' </summary>
    ''' <param name="INIPath">The INI path.</param><returns></returns>
